...
function Home(props){ 
	...
	return (
		<div className="d-flex flex-column align-items-center justify-content-center">
			...
			<div className="mt-5">
				<button className="btn ms-3 fs-1 control-button text-white" onClick={() => props.stop()}><i class="fa-solid fa-stop"></i></button>
				<button className="btn ms-3 fs-1 control-button text-white" onClick={() => props.resume()}><i class="fa-solid fa-play"></i></button>
				<button className="btn ms-3 fs-1 control-button text-white" onClick={() => props.restart()}><i class="fa-solid fa-arrow-rotate-left"></i></button>
			</div>
			<div className="mt-5">
